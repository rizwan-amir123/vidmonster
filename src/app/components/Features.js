export default function Features({src}) {
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div className="p-5 bg-gradient-to-r from-[#4adb0d] to-transparent rounded-lg">
                <div className="shadow-md shadow-white flex justify-center items-center rounded-full mb-4 w-10 h-10 bg-[#4f19bb] lg:h-12 lg:w-12 dark:bg-primary-900 transition duration-100 ease-in-out hover:rotate-180">
    ...
    <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z"/>
            ...
            <div className="p-5 bg-gradient-to-r from-[#4adb0d] to-transparent rounded-lg">
                <div className="shadow-md shadow-white flex justify-center items-center rounded-full mb-4 w-10 h-10 bg-[#4f19bb] lg:h-12 lg:w-12 dark:bg-primary-900 transition duration-100 ease-in-out hover:rotate-90">
